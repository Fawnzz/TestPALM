<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfigurationItem_Old.aspx.cs" Inherits="PALMProjectv1.ConfigurationItem_Old" %>
        ...
        <div class="row">
            <div class="col-md-12">
               ...
               <div id="gvDisabledCI" class="row mymargin table-responsive">
                   <asp:GridView ID="gvGetOldCI" CssClass="table table-hover" runat="server" AutoGenerateColumns="False" DataSourceID="dsPALMCI" OnRowCommand="gvGetOldCI_RowCommand" DataKeyNames="CIID1">
                       <Columns>
                           ...
                           <asp:TemplateField>
                               <ItemTemplate>
                                   <asp:Button ID="btnReactivate" CssClass="palmButton btn btn-default" style="width:50%; align-content:center" runat="server" Text="Reactivate" CommandName="ReactivateCI" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                               </ItemTemplate> 
                           </asp:TemplateField>
                       </Columns>
                   </asp:GridView>
                   <asp:SqlDataSource ID="dsPALMCI" runat="server" ConnectionString="<%$ ConnectionStrings:PALM3ConnectionString2 %>" SelectCommand="spGetLatestVersionOldCI" SelectCommandType="StoredProcedure">
                       <SelectParameters>
